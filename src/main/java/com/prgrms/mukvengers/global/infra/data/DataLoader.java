...
public class DataLoader {
	...
	public void loadSetCrewAndPeople(int count, StoreRepository storeRepository,
		...
		jdbcTemplate.batchUpdate(
			InsertQuery.CREW_MEMBER_INSERT_SQL.sql(), new BatchPreparedStatementSetter() {
	...
	public void loadUser(int count) {
		...
		jdbcTemplate.batchUpdate(
			InsertQuery.USER_INSERT.sql(), new BatchPreparedStatementSetter() {
	...
	public void loadStore(int count) {
		...
		jdbcTemplate.batchUpdate(
			InsertQuery.STORE_INSERT_SQL.sql(), new BatchPreparedStatementSetter() {
				@Override
				public void setValues(PreparedStatement ps, int i) throws SQLException {
	...
	public void loadCrew(int count, StoreRepository storeRepository) {
		...
		jdbcTemplate.batchUpdate(
			InsertQuery.CREW_INSERT_SQL.sql(), new BatchPreparedStatementSetter() {
				@Override
				public void setValues(PreparedStatement ps, int i) throws SQLException {

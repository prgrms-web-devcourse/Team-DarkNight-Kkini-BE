package com.prgrms.mukvengers.global.infra.alarm;
...
import com.prgrms.mukvengers.global.infra.alarm.dto.RequestInfo;
...
public class SlackNotificationAspect {
	...
	@Around("@annotation(com.prgrms.mukvengers.global.infra.alarm.annotation.Alarm) && args(request, e)")
